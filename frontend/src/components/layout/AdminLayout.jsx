...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:sticky top-0 left-0 z-50 h-screen w-64 glass-card-static border-r border-white/5 rounded-none flex flex-col transition-transform duration-300 ${
        ...
        <div className="p-5 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/40">Absensi KKN</p>
            </div>
          </div>
        </div>
